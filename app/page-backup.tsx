        ...
        <main className="flex-1 overflow-y-auto p-6">
          <div className="max-w-7xl mx-auto space-y-6 animate-fade-in">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
              <StatsCard title="Weekly Goal" value="3/4" change="75% complete" icon={TrendingUp} trend="up" />
              ...
              <div className="space-y-6">
                ...
                <Card className="card-linear">
                  <CardHeader>
                    ...
                    <CardDescription>Muscle groups trained this week</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-3">
                      <div className="flex justify-between text-sm">
                        <span>5 of 6 muscle groups</span>
                        <span>83%</span>
                      </div>
                      <Progress value={83} className="h-2" />
                      <div className="grid grid-cols-3 gap-2 text-xs">
                        <Badge variant="secondary" className="text-center">Chest ✓</Badge>
                        <Badge variant="secondary" className="text-center">Back ✓</Badge>
                        <Badge variant="secondary" className="text-center">Legs ✓</Badge>
                        <Badge variant="secondary" className="text-center">Arms ✓</Badge>
                        <Badge variant="secondary" className="text-center">Core ✓</Badge>
                        <Badge variant="outline" className="text-center">Shoulders</Badge>
                      </div>
                    </div>
                  </CardContent>
                </Card>
